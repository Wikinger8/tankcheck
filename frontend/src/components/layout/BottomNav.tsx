...
const tabs = [
  {
    ...
    href: '/',
    icon: (a: boolean) => (
      <svg xmlns="http://www.w3.org/2000/svg" fill={a ? 'currentColor' : 'none'} viewBox="0 0 24 24" strokeWidth={a ? 0 : 1.5} stroke="currentColor" className="w-6 h-6">
        {a ? (
  ...
  },
  {
    ...
    href: '/list',
    icon: (a: boolean) => (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={a ? 2.5 : 1.5} stroke="currentColor" className="w-6 h-6">
...
export function BottomNav() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 bg-white/95 dark:bg-gray-950/95 backdrop-blur-lg border-t border-gray-200 dark:border-gray-800 z-[1100]"
